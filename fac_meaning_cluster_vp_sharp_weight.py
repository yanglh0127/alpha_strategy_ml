...
fac_meaning = pd.read_excel(data_pat + '/fac_meaning.xlsx', sheet_name='日频量价', index_col=0)
...
rank_corr = pd.read_csv('E:/Share/FengWang/Alpha/mine/price_volume/rank_corr.csv', index_col=0)
out_path = 'E:/FT_Users/LihaiYang/Files/factor_comb_data/fac_meaning/vp/sharpe_weight'  # 记得修改
# 日间成交量(额)的波动率、反转因子相关、量价相关性、收益率和波动率的相关性、情绪因子、流动性因子相关
...
# 把聚合因子的表现结果汇总
type = 'sharpe_weight'  # 记得修改
perf_path = 'E:/FT_Users/LihaiYang/Files/factor_comb_data/fac_meaning/vp/' + str(type) + '/eq_tvwap'
results_perf = {}
results_hperf = {}
results_to = {}
