...
out_path = 'E:/FT_Users/LihaiYang/Files/factor_comb_data/fac_meaning/mf/sharpe_weight_1'  # 记得修改
# '开盘资金流的日间波动' '资金流的日间波动' '收盘资金流的日间波动' '主力单数行为' '主力流入占比' '主力流出占比'
# '主力净流入的绝对值' '反转因子改进' '价格和资金流向的相关性' '开盘净主动买入行为' '开盘和收盘净主动买入之差'
# '主力净流入占比的偏度' '主力净流入的时间趋势绝对值' '收盘主力净流入行为'
