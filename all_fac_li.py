...
# 读取李加虎因子表现汇总 # user = 'wangfeng:847,847,845','yyzhao:304,220,176','JiahuLi:191,189','Alex:195,194','cshu:97,'
mine_summary = query_data.get_alphafactors_info(user='JiahuLi')
...
f = open('E:/FT_Users/LihaiYang/Files/factor_comb_data/all_fac_li_20170101-20210228/all_fac_li_20170101-20210228.pkl', 'wb')
