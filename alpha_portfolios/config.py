...
path_results = 'E:/FT_Users/LihaiYang/Files/factor_comb_data/fac_meaning/5group/linear_model/gradient_boost_tune/eq_tvwap'  # 记得修改

# 回测参数
PARAMS_BT = {
    "buy_commission": 0.00015,  # 买入成本，选择用均价交易时，可以不增加交易冲击，交易冲击默认0.001  # 原本为万分之二
    "sell_commission": 0.00015,  # 卖出成本，选择用均价交易时，可以不考虑交易冲击  # 原本为万分之二
    "tax_ratio": 0.001,  # 印花税
