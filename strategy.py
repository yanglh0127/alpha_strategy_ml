...
data_pat = 'E:/FT_Users/LihaiYang/Files/factor_comb_data/fac_meaning/5group/linear_model/elnet'  # 这边路径记得改
pm_pat = 'eq_tvwap'  # 记得修改
fac_data = pd.read_pickle(data_pat + '/fac_0.1_0.00035.pkl')  # 记得修改
